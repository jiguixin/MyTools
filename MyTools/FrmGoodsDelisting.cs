...
namespace MyTools
{
    public partial class FrmGoodsDelisting : Form
    {
        ...
        private void btnAssignDelisting_Click(object sender, EventArgs e)
        {
            IsSearch = false;
            if (!bgwRun.IsBusy)
            {
        ...
        private void bgwRun_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (IsSearch)
            {
                _goodsApi.GoodsDelistingFromOnSale(lstSearchs);
            }
            else
            {
                foreach (var search in lstSearchs)
                {
                    ...
                    _goodsApi.GoodsDelisting(search.ToType<Int64>());
                }
            }
