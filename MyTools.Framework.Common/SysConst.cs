...
namespace MyTools.Framework.Common
{
    public class SysConst
    {
        ...
        static SysConst()
        {
            ...
            WomenCatalogBanggoToTaobaoCid.Add("大衣", "50013194");//毛呢外套
            WomenCatalogBanggoToTaobaoCid.Add("茄克", "50013194");//毛呢外套
            

            ManCatalogBanggoToTaobaoCid.Add("裤类", "50010167");//牛仔裤
            ManCatalogBanggoToTaobaoCid.Add("西装", "50010160");//西服
            ManCatalogBanggoToTaobaoCid.Add("茄克", "50010158");//夹克
            ManCatalogBanggoToTaobaoCid.Add("大衣", "50025883");//呢大衣
