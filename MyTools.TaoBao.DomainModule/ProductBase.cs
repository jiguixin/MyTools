...
namespace MyTools.TaoBao.DomainModule
{
    public class ProductBase
    {
        ...
        /// 售后说明模板id
        /// </summary>
        public virtual Nullable<long> AfterSaleId { get; set; }

        /// <summary>
        /// 商品上传后的状态。可选值:onsale(出售中),instock(仓库中);默认值:onsale
        /// </summary>
        public virtual string ApproveStatus { get; set; }
        ...
        /// </summary>
        public virtual Nullable<long> AuctionPoint { get; set; }

        /// <summary>
        /// 代充商品类型。在代充商品的类目下，不传表示不标记商品类型（交易搜索中就不能通过标记搜到相关的交易了）。可选类型：  no_mark(不做类型标记)  time_card(点卡软件代充)  fee_card(话费软件代充)
        /// </summary>
        public virtual string AutoFill { get; set; }

        /// <summary>
        /// 商品基础色，数据格式为：pid:vid:rvid1,rvid2,rvid3;pid:vid:rvid1
        /// </summary>
        public virtual string ChangeProp { get; set; }

        /// <summary>
        /// 叶子类目id
        /// </summary>
        public virtual Nullable<long> Cid { get; set; }

        /// <summary>
        /// 此为货到付款运费模板的ID，对应的JAVA类型是long,如果COD卖家应用了货到付款运费模板，此值要进行设置。
        /// </summary>
        public virtual Nullable<long> CodPostageId { get; set; }
        ...
        /// </summary>
        public virtual string EmsFee { get; set; }

        /// <summary>
        /// 快递费用。取值范围:0.01-999.00;精确到2位小数;单位:元。如:15.07，表示:15元7分
        /// </summary>
        public virtual string ExpressFee { get; set; }

        /// <summary>
        /// 厂家联系方式
        /// </summary>
        public virtual string FoodSecurityContact { get; set; }

        /// <summary>
        /// 产品标准号
        /// </summary>
        public virtual string FoodSecurityDesignCode { get; set; }

        /// <summary>
        /// 厂名
        /// </summary>
        public virtual string FoodSecurityFactory { get; set; }

        /// <summary>
        /// 厂址
        /// </summary>
        public virtual string FoodSecurityFactorySite { get; set; }

        /// <summary>
        /// 食品添加剂
        /// </summary>
        public virtual string FoodSecurityFoodAdditive { get; set; }

        /// <summary>
        /// 配料表
        /// </summary>
        public virtual string FoodSecurityMix { get; set; }

        /// <summary>
        /// 保质期
        /// </summary>
        public virtual string FoodSecurityPeriod { get; set; }

        /// <summary>
        /// 储藏方法
        /// </summary>
        public virtual string FoodSecurityPlanStorage { get; set; }

        /// <summary>
        /// 生产许可证号
        /// </summary>
        public virtual string FoodSecurityPrdLicenseNo { get; set; }

        /// <summary>
        /// 生产结束日期,格式必须为yyyy-MM-dd
        /// </summary>
        public virtual string FoodSecurityProductDateEnd { get; set; }

        /// <summary>
        /// 生产开始日期，格式必须为yyyy-MM-dd
        /// </summary>
        public virtual string FoodSecurityProductDateStart { get; set; }

        /// <summary>
        /// 进货结束日期，要在生产日期之后，格式必须为yyyy-MM-dd
        /// </summary>
        public virtual string FoodSecurityStockDateEnd { get; set; }

        /// <summary>
        /// 进货开始日期，要在生产日期之后，格式必须为yyyy-MM-dd
        /// </summary>
        public virtual string FoodSecurityStockDateStart { get; set; }

        /// <summary>
        /// 供货商
        /// </summary>
        public virtual string FoodSecuritySupplier { get; set; }
        ...
        /// </summary>
        public virtual string GlobalStockType { get; set; }

        /// <summary>
        /// 支持会员打折。可选值:true,false;默认值:false(不打折)
        /// </summary>
        public virtual Nullable<bool> HasDiscount { get; set; }

        /// <summary>
        /// 是否有发票。可选值:true,false (商城卖家此字段必须为true);默认值:false(无发票)
        /// </summary>
        public virtual Nullable<bool> HasInvoice { get; set; }

        /// <summary>
        /// 橱窗推荐。可选值:true,false;默认值:false(不推荐)
        /// </summary>
        public virtual Nullable<bool> HasShowcase { get; set; }

        /// <summary>
        /// 是否有保修。可选值:true,false;默认值:false(不保修)
        /// </summary>
        public virtual Nullable<bool> HasWarranty { get; set; }

        /// <summary>
        /// 商品主图片。类型:JPG,GIF;最大长度:500K
        /// </summary>
        public virtual FileItem Image { get; set; }
        ...
        /// </summary>
        public virtual string InputPids { get; set; }
        ...
        /// </summary>
        public virtual string InputStr { get; set; }

        /// <summary>
        /// 是否是3D
        /// </summary>
        public virtual Nullable<bool> Is3D { get; set; }

        /// <summary>
        /// 是否在外店显示
        /// </summary>
        public virtual Nullable<bool> IsEx { get; set; }

        /// <summary>
        /// 实物闪电发货
        /// </summary>
        public virtual Nullable<bool> IsLightningConsignment { get; set; }

        /// <summary>
        /// 是否在淘宝上显示（如果传FALSE，则在淘宝主站无法显示该商品）
        /// </summary>
        public virtual Nullable<bool> IsTaobao { get; set; }
        ...
        /// </summary>
        public virtual Nullable<bool> IsXinpin { get; set; }
        ...
        /// </summary>
        public virtual string ItemWeight { get; set; }
        ...
        /// </summary>
        public virtual Nullable<DateTime> ListTime { get; set; }

        /// <summary>
        /// 发布电子凭证宝贝时候表示是否使用邮寄 0: 代表不使用邮寄； 1：代表使用邮寄；如果不设置这个值，代表不使用邮寄
        /// </summary>
        public virtual string LocalityLifeChooseLogis { get; set; }

        /// <summary>
        /// 本地生活电子交易凭证业务，目前此字段只涉及到的信息为有效期;  如果有效期为起止日期类型，此值为2012-08-06,2012-08-16  如果有效期为【购买成功日 至】类型则格式为2012-08-16  如果有效期为天数类型则格式为15
        /// </summary>
        public virtual string LocalityLifeExpirydate { get; set; }

        /// <summary>
        /// 码商信息，格式为 码商id:nick
        /// </summary>
        public virtual string LocalityLifeMerchant { get; set; }

        /// <summary>
        /// 网点ID
        /// </summary>
        public virtual string LocalityLifeNetworkId { get; set; }

        /// <summary>
        /// 电子凭证售中自动退款比例，百分比%前的数字，介于1-100之间的整数
        /// </summary>
        public virtual Nullable<long> LocalityLifeOnsaleAutoRefundRatio { get; set; }

        /// <summary>
        /// 退款比例，  百分比%前的数字,1-100的正整数值
        /// </summary>
        public virtual Nullable<long> LocalityLifeRefundRatio { get; set; }

        /// <summary>
        /// 核销打款   1代表核销打款 0代表非核销打款
        /// </summary>
        public virtual string LocalityLifeVerification { get; set; }
        ...
        /// </summary>
        public virtual Nullable<long> Num { get; set; }
        ...
        /// </summary>
        public virtual string PostFee { get; set; }

        /// <summary>
        /// 宝贝所属的运费模板ID。取值范围：整数且必须是该卖家的运费模板的ID（可通过taobao.delivery.template.get获得当前会话用户的所有邮费模板）
        /// </summary>
        public virtual Nullable<long> PostageId { get; set; }
        ...
        /// </summary>
        public virtual string PropertyAlias { get; set; }
        ...
        /// </summary>
        public virtual string ScenicTicketBookCost { get; set; }

        /// <summary>
        /// 景区门票类宝贝发布时候，当卖家签订了支付宝代扣协议时候，需要选择支付方式：全额支付和订金支付。当scenic_ticket_pay_way为1时表示全额支付，为2时表示订金支付
        /// </summary>
        public virtual Nullable<long> ScenicTicketPayWay { get; set; }

        /// <summary>
        /// 是否承诺退换货服务!虚拟商品无须设置此项!
        /// </summary>
        public virtual Nullable<bool> SellPromise { get; set; }

        /// <summary>
        /// 商品所属的店铺类目列表。按逗号分隔。结构:",cid1,cid2,...,"，如果店铺类目存在二级类目，必须传入子类目cids。
        /// </summary>
        public virtual string SellerCids { get; set; }
        ...
        /// </summary>
        public virtual string SkuOuterIds { get; set; }

        /// <summary>
        /// Sku的价格串，结构如：10.00,5.00,… 精确到2位小数;单位:元。如:200.07，表示:200元7分
        /// </summary>
        public virtual string SkuPrices { get; set; }
        ...
        /// </summary>
        public virtual string SkuProperties { get; set; }

        /// <summary>
        /// Sku的数量串，结构如：num1,num2,num3 如：2,3
        /// </summary>
        public virtual string SkuQuantities { get; set; }

        /// <summary>
        /// 新旧程度。可选值：new(新)，second(二手)，unused(闲置)。B商家不能发布二手商品。  如果是二手商品，特定类目下属性里面必填新旧成色属性
        /// </summary>
        public virtual string StuffStatus { get; set; }

        /// <summary>
        /// 商品是否支持拍下减库存:1支持;2取消支持(付款减库存);0(默认)不更改 集市卖家默认拍下减库存; 商城卖家默认付款减库存
        /// </summary>
        public virtual Nullable<long> SubStock { get; set; }
        ...
        /// </summary>
        public virtual Nullable<long> ValidThru { get; set; }

        /// <summary>
        /// 商品的重量(商超卖家专用字段)
        /// </summary>
        public virtual Nullable<long> Weight { get; set; }
