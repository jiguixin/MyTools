...
{
    /// <summary>
    /// TOP API: tmall.wangwangfenliu.rule.hanoi.update
    /// </summary>
    public class TmallWangwangfenliuRuleHanoiUpdateRequest : ITopRequest<TmallWangwangfenliuRuleHanoiUpdateResponse>
    {
        /// <summary>
        /// 汉诺塔的分组ID[条件]
        /// </summary>
        ...
        {
            return "tmall.wangwangfenliu.rule.hanoi.update";
        }
