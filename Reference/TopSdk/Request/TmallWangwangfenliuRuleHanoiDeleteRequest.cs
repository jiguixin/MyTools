...
{
    /// <summary>
    /// TOP API: tmall.wangwangfenliu.rule.hanoi.delete
    /// </summary>
    public class TmallWangwangfenliuRuleHanoiDeleteRequest : ITopRequest<TmallWangwangfenliuRuleHanoiDeleteResponse>
    {
        /// <summary>
        /// 汉诺塔的分组ID
        /// </summary>
